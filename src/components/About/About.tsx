    ...
    <div className="">
      ...
      <div  className="container mx-auto px-6">
        ...
        <Info
            ...
            Info2={"Delivering work within time and budget which meets client's requirements is our moto. Lorem Ipsum has been the industry's standard dummy text ever when an unknown printer took a galley."}
          />
